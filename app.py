...
Original file is located at
    https://colab.research.google.com/drive/1WyyQM70hikivH0hFoq9fx_cjwYrJXSGW
"""
...
if infoType == 'Moving Average Chart':
	...
	st.pyplot(fig5)
        ...
        fig.update_layout(
            title={
                'text': "OIL Prices Over Past Two Years",
                'y': 0.9,
                'x': 0.5,
                'xanchor': 'center',
                'yanchor': 'top'})
...
st.subheader('OIL Price Prediction by Date')
